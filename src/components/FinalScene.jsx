      ...
      <div className="relative z-10 max-w-4xl w-full flex flex-col items-center justify-center min-h-[60vh]">
        ...
        {step >= 2 && step < 10 && (
          <div className="mt-8 sm:mt-12 space-y-6 sm:space-y-8 px-2">
            {step >= 2 && <p className="text-lg sm:text-xl md:text-2xl text-gray-300 animate-fade-in leading-relaxed">في يوم زي النهارده… <span className="text-primary-300 font-bold block mt-2 text-xl sm:text-2xl md:text-3xl">اتولد Weaam، أعز إنسان في حياة Doha.</span></p>}
            {step >= 3 && <p className="text-lg sm:text-xl md:text-2xl text-gray-300 animate-fade-in mt-6 sm:mt-8 leading-relaxed">Doha عايزة تقولك… <span className="text-primary-400 font-bold block mt-2 text-xl sm:text-2xl md:text-3xl">إنت أغلى حد في حياتي يا Weaam.</span></p>}
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black animate-fade-in px-2">
            ...
            {step >= 14 && (
              <p className="mt-6 sm:mt-8 text-sm sm:text-lg md:text-xl text-primary-200 font-light animate-slide-up max-w-2xl leading-relaxed px-4">
                "يا Weaam، ربنا يخليك ويباركلك في عمرك، ويعمل كل خير ليك. كل سنة وانت طيب يا أغلى إنسان.. Doha بتحبك ❤️"
              </p>
            )}
          </div>
        )}
