      ...
      <div className="relative z-10 max-w-4xl w-full flex flex-col items-center justify-center min-h-[60vh]">
        ...
        {step >= 2 && step < 10 && (
          <div className="mt-8 sm:mt-12 space-y-6 sm:space-y-8 px-2">
            ...
            {step >= 3 && <p className="text-lg sm:text-xl md:text-2xl text-gray-300 animate-fade-in mt-6 sm:mt-8 leading-relaxed">عايزه اقولك… <span className="text-primary-400 font-bold block mt-2 text-xl sm:text-2xl md:text-3xl">إنت أغلى حد في حياتي يا Weaam.</span></p>}
